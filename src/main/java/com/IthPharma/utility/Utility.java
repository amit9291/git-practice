package com.IthPharma.utility;


import com.google.common.base.Function;
import com.IthPharma.browserfactory.ManageBrowser;
...
public class Utility extends ManageBrowser {
     ...
     */
    public int generateRandomNumber(int entermobileNumber) {
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/IthPharma/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/IthPharma/screenshots/" + screenshotName + dateName + ".png";
